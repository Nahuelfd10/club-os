  ...
  useEffect(() => {
    ...
    const preparePasswordReset = async () => {
      ...
      if (result.error || !session) {
        ...
        setErrorMessage("Para crear una contrasena nueva, abri el enlace que te enviamos por email.");
      } else {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
      <Card className="w-full max-w-sm p-6">
        ...
        <Link href={routes.clubPath("login")} className="mt-4 inline-block text-sm font-semibold text-primary">
          Volver al login
        </Link>
      </Card>
    </main>
