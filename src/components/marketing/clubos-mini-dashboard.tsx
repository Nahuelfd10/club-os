    ...
    <section className="rounded-[2rem] border border-white/10 bg-white/6 p-6 shadow-[0_24px_60px_-42px_rgba(0,0,0,0.85)] backdrop-blur-xl sm:p-8">
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="grid gap-4 sm:grid-cols-3">
          <Reveal delayMs={80}>
            <article className="h-full rounded-[1.5rem] border border-white/10 bg-black/18 p-5">
        ...
        <Reveal delayMs={180}>
          <div className="h-full rounded-[1.6rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06)_0%,rgba(255,255,255,0.02)_100%)] p-5">
